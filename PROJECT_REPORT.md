...
**② 요금제 혼입.** 원본의 23.4%를 차지하는 Flex Fare는 요금 산정 방식 자체가 다르다. **표준 미터 요금(`RatecodeID = 1`)만 남겨** 다시 비교해도 주말은 여전히 더 빠르고(9.15 → 10.39 mph, **+13.6%**) 마일당 비용이 낮으며($13.70 → $12.12, **-11.5%**), **거리는 오히려 3.5% 더 길다**(2.56 → 2.65 mi).
